...
import { CreateProduct } from '../../../app/features/product/application/usecase/create_product'
...
export default defineEventHandler(async (event) => {
  ...
  const result = await new CreateProduct(repository).execute(await readBody(event))
